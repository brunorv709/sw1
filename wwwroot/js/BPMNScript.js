...
(function (factory) {
    ...
    function init() {
        ...
        $(go.Panel, 'Spot', 
        $(go.Picture, //'RoundedRectangle', // the outside rounded rectangle
        {
            source: pathGeneric + "/person.svg",
            name: 'SHAPE',
        ...
        {
            alignment: go.Spot.Center, textAlign: 'center', margin: 12, stroke: 'white',
            editable: true
        }, new go.Binding('text').makeTwoWay())) // end Auto Panel
        ); // end go.Node, which is a Spot Panel with bound itemArray
        // ---------------------------------------------------------Activity block node
        var activityNodeTemplate2 = $(go.Node, 'Spot', {
            locationObjectName: 'SHAPE', locationSpot: go.Spot.Center,
            resizable: true, resizeObjectName: 'PANEL',
            toolTip: tooltiptemplate,
            selectionAdorned: false,
        ...
        $(go.Picture, //'RoundedRectangle', // the outside rounded rectangle
        {
            source: pathGeneric + "/container1.svg",
            name: 'SHAPE',
            //fill: ActivityNodeFill, stroke: ActivityNodeStroke,
            //parameter1: 10,
            portId: '', fromLinkable: true, toLinkable: true, cursor: 'pointer',
        ...
        //-------------------------------------------------------------------------------------------------------------
        var activityNodeTemplate3 = $(go.Node, 'Spot', {
            locationObjectName: 'SHAPE', locationSpot: go.Spot.Center,
            resizable: true, resizeObjectName: 'PANEL',
            toolTip: tooltiptemplate,
            selectionAdorned: false,
            ...
            new go.Binding('layerName', 'isSelected', function (s) { return s ? 'Foreground' : ''; }).ofObject(), $(go.Panel, 'Auto', {
                ...
                $(go.Panel, 'Spot',
                    $(go.Picture, //'RoundedRectangle', // the outside rounded rectangle
                        {
                            source: pathGeneric + "/container2.svg",
                            name: 'SHAPE',
                            //fill: ActivityNodeFill, stroke: ActivityNodeStroke,
                            //parameter1: 10,
                            portId: '', fromLinkable: true, toLinkable: true, cursor: 'pointer',
        ...
        //--------------------------------------------------------------------------------------------------------------
        var activityNodeTemplateBlanco = $(go.Node, 'Spot', {
            locationObjectName: 'SHAPE', locationSpot: go.Spot.Center,
            resizable: true, resizeObjectName: 'PANEL',
            toolTip: tooltiptemplate,
            selectionAdorned: false,
            ...
            new go.Binding('layerName', 'isSelected', function (s) { return s ? 'Foreground' : ''; }).ofObject(), $(go.Panel, 'Auto', {
                ...
                $(go.Panel, 'Spot',
                    $(go.Picture, //'RoundedRectangle', // the outside rounded rectangle
                        {
                            source: pathGeneric + "/fondo_blanco.png",
                            name: 'SHAPE',
                            //fill: ActivityNodeFill, stroke: ActivityNodeStroke,
                            //parameter1: 10,
                            portId: '', fromLinkable: true, toLinkable: true, cursor: 'pointer',
        ...
        $(go.Picture, //'Circle', // Inner circle
        { 
            source: pathGeneric + "/capture.png", 
            alignment: go.Spot.Center, 
            desiredSize: new go.Size(EventNodeInnerSize, EventNodeInnerSize), 
            //fill: null 
        }, new go.Binding('stroke', 'eventDimension', nodeEventDimensionStrokeColorConverter), new go.Binding('strokeDashArray', 'eventDimension', function (s) { return (s === 3 || s === 6) ? [4, 2] : null; }), // dashes for non-interrupting
        ...
        var dataStoreNodeTemplate = $(go.Node, 'Vertical', { locationObjectName: 'SHAPE', locationSpot: go.Spot.Center }, new go.Binding('location', 'loc', go.Point.parse).makeTwoWay(go.Point.stringify), 
        $(go.Picture, //'Database', 
        {
            source: pathGeneric + "/Capture3.png",
            name: 'SHAPE', portId: '', fromLinkable: true, toLinkable: true, cursor: 'pointer',
            //fill: DataFill, 
        ...
        var picturetemplate = $(go.Node, "Auto",{
            locationObjectName: 'SHAPE',
            locationSpot: go.Spot.Center,
            toolTip: tooltiptemplate
            ...
            /*{ resizable: false, resizeObjectName: 'SHAPE' }, $(go.Panel, 'Spot', $(go.Shape, 'Circle', // Outer circle
            {
                ...
                $(go.Picture,
                    { source: pathGeneric + "/capture.png", column: 0, margin: 2 },
                    new go.Binding("text", "text")),
                    $(go.TextBlock, new go.Binding("text", "text"), { margin: 2 })
        );
...
*/
        ...
        nodeTemplateMap.add('activityBlanco', activityNodeTemplateBlanco);
        nodeTemplateMap.add('activity', activityNodeTemplate);
        nodeTemplateMap.add('activityBox', activityNodeTemplate2);
        nodeTemplateMap.add('activityBox2', activityNodeTemplate3);
        ...
        palNodeTemplateMap.add('activityBlanco', activityNodeTemplateBlanco);
        palNodeTemplateMap.add('activity', activityNodeTemplate);
        palNodeTemplateMap.add('activityBox', activityNodeTemplate2);
        palNodeTemplateMap.add('activityBox2', activityNodeTemplate3);
        ...
        }, new go.Binding('points').makeTwoWay(), $(go.Shape, { stroke: 'green', strokeWidth: 1, strokeDashArray: [6, 2] }), $(go.Shape, { toArrow: 'Triangle', scale: 1, fill: 'white', stroke: 'black' }), $(go.Shape, { fromArrow: 'Circle', scale: 1, visible: true, stroke: 'black', fill: 'white' }), $(go.TextBlock, {
        ...
        }, new go.Binding('points').makeTwoWay(), $(go.Shape, { stroke: 'black', strokeWidth: 1, strokeDashArray: [1, 3] }), $(go.Shape, { toArrow: 'OpenTriangle', scale: 1, fill: null, stroke: 'blue' }), $(go.Shape, { fromArrow: 'Circle', scale: 1, visible: true, stroke: 'black', fill: 'white' }), $(go.TextBlock, {
            editable: true, text: 'Dependency'
        }, // Link label
            new go.Binding('text', 'text').makeTwoWay()));

        var dataAssociationLinkTemplate2 = $(go.Link, {
            routing: go.Link.AvoidsNodes, curve: go.Link.JumpGap, corner: 10,
            fromSpot: go.Spot.AllSides, toSpot: go.Spot.AllSides,
            reshapable: true, relinkableFrom: true, relinkableTo: true
        }, new go.Binding('points').makeTwoWay(), $(go.Shape, { stroke: 'black', strokeWidth: 1 }), $(go.Shape, { toArrow: 'OpenTriangle', scale: 1, fill: null, stroke: 'blue' }), $(go.Shape, { fromArrow: 'Circle', scale: 1, visible: true, stroke: 'black', fill: 'white' }), $(go.TextBlock, {
            editable: true, text: 'Data Flow'
        }, // Link label
            new go.Binding('text', 'text').makeTwoWay()));
        ...
        }, new go.Binding('points').makeTwoWay(), $(go.Shape, { stroke: 'red', strokeWidth: 1, strokeDashArray: [1, 3] }), $(go.Shape, { toArrow: 'OpenTriangle', scale: 1, stroke: 'black' }));
        var linkTemplateMap = new go.Map();
        linkTemplateMap.add('msg', messageFlowLinkTemplate);
        linkTemplateMap.add('activity', dataAssociationLinkTemplate2);
        linkTemplateMap.add('annotation', annotationAssociationLinkTemplate);
        linkTemplateMap.add('data', dataAssociationLinkTemplate);
        linkTemplateMap.add('', dataAssociationLinkTemplate2); // default
        // ------------------------------------------the main Diagram----------------------------------------------
        myDiagram =
        ...
        myDiagram.addDiagramListener('LinkDrawn', function (e) {
            ...
            else if (e.subject.fromNode.category === 'activity' || e.subject.toNode.category === 'activity') {
                e.subject.category = 'activity'; // data association
            }
        });
        myDiagram.addModelChangedListener(function(evt) {
            if (evt.isTransactionFinished && evt.jp != "Initial Layout") {
                let pJson = myDiagram.model.toJson();

                ChangeFinishedJson(pJson);
            }
        });
        ...
        myPaletteLevel1.model = $(go.GraphLinksModel, {
            ...
            nodeDataArray: [
                ...
                // -------------------------- Task/Activity Nodes
                { key: 130, category: 'activityBlanco', text: '', item: 'generic task', taskType: 0 },
                { key: 131, category: 'activity', text: 'Person', item: 'generic task', taskType: 0 },
                { key: 132, category: 'activityBox', text: 'Container', item: 'User task', taskType: 0 },
                { key: 133, category: 'activityBox2', text: 'Container', item: 'User task', taskType: 0 },
                // -------------------------- Gateway Nodes, Data, Pool and Annotation
                //{ key: 302, category: 'datastore', text: 'Data Store'  },
                //{ key: 701, category: 'annotation', text: 'nota' },
            ] // end nodeDataArray
        }); // end model
    ...
    function GetJson() {
        ...
        let cargarJson = { "class": "GraphLinksModel",
        "nodeDataArray": [
        {"key":132,"category":"activity","text":"User Task","item":"User task","taskType":2,"loc":"-183.640625 24"},
        {"key":302,"category":"datastore","text":"Data\nStorage","loc":"113.359375 143"}
        ],
        "linkDataArray": [{"from":132,"to":302,"category":"data","points":[-123.640625,24,-113.640625,24,-15.890625,24,-15.890625,143,81.859375,143,91.859375,143]}]
        }
        */
        let pJsonActual = myDiagram.model.toJson();
        let cargarJson = document.getElementById("pJsonValue").value;

        
        if (pJsonActual != cargarJson) {
            myDiagram.animationManager.initialAnimationStyle = go.AnimationManager.None;
            myDiagram.model = go.Model.fromJson(cargarJson);
            //myDiagram.initialContentAlignment = go.Spot.None;
